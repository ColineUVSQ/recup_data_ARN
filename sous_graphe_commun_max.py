...
def sous_graphe_commun_max():
    ...
    if 'tab_calcules_sim_nouvelle_metrique.pickle' in os.listdir() :
        #with open("tab_calcules_sim_"+nom_extension+".pickle", 'rb') as fichier_deja_fait :
        with open("tab_calcules_sim_nouvelle_metrique.pickle", 'rb') as fichier_deja_fait :
    ...
    if 'fichier_max_nouvelle_metrique.pickle' in os.listdir() :
        #with open("fichier_max_"+nom_extension+".pickle", 'rb') as fichier_max_pickle :
        with open("fichier_max_nouvelle_metrique.pickle", 'rb') as fichier_max_pickle :
    ...
    if 'dico_graphes_communs_max_nouvelle_metrique.pickle' in os.listdir() :
        #with open("fichier_max_"+nom_extension+".pickle", 'rb') as fichier_max_pickle :
        with open("dico_graphes_communs_max_nouvelle_metrique.pickle", 'rb') as dico_max_pickle :
            mon_depickler_dico = pickle.Unpickler(dico_max_pickle)
            dico_graphes = mon_depickler_dico.load()
    else :
        dico_graphes = {}
    ...
    with open("fichier_similarite_nouvelle_metrique.txt", 'a') as fichier_ecriture :
                                                    ...
                                                    for compt_2 in range(max(len(couples_possibles[1]), 1)) :
                                                        ...
                                                        for compt_3 in range(max(len(couples_possibles[2]), 1)) :
                                                            ...
                                                            for compt_4 in range(max(len(couples_possibles[3]), 1)) :
                                                                ...
                                                                sim = calcul_sim_avec_poids(graphe1, graphe2, graphe_commun)
                                                                
                                                                
                                                                if elt_3 == [(3,3), (56,27), (58,29), (69,31)] and elt_4 == [(4,4), (22,12), (29,13), (31,15), (35,18), (32,20)] :
                                                                    print(elt_1)
                                                                    print(elt_2)
                                                                    print(elt_3)
                                                                    print(elt_4)
