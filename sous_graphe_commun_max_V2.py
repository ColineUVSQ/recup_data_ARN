...
def comparaison(elt, graphe1, graphe2, couples_possibles, num, graphe_commun) :
    deja_vus_voisin_1 = []
    deja_vus_voisin_2 = []
    sommets_en_plus_1 = []
    sommets_en_plus_2 = []
...
#                    
                ...
                for edge_1 in dict_voisin_1 :
                    for edge_2 in dict_voisin_2 :
                        ...
                        if bonne_chaine :
                            ...
                            if label_1 == label_2 :
                                if ((elt[i][0], voisin_1), (elt[i][1], voisin_2)) not in [((1,1), (2,2)),((1,1), (3,3)),((1,1), (5,5)),((2,2), (4,4)),((2,2),(5,5)),((3,3),(4,4))] :
                                    if label_1 == 'COV' :
    ...
    pas_bonne_chaine = False
    for couple in couples_en_plus :
        if num not in graphe1.nodes[couple[0]]["chaine"] or num not in graphe2.nodes[couple[1]]["chaine"] :
            pas_bonne_chaine = True
   
#     if num == 2 :
#         print(couples_en_plus)
#         print(pas_bonne_chaine)
    
    #print(couples_possibles[0])
    if pas_bonne_chaine == False :
        max_deja = 0
...
def sous_graphe_commun_max(nom_extension):
    ...
    if 'tab_calcules_sim_qui_manquent_dernier.pickle' in os.listdir() :
        #with open("tab_calcules_sim_"+nom_extension+".pickle", 'rb') as fichier_deja_fait :
        with open("tab_calcules_sim_qui_manquent_dernier.pickle", 'rb') as fichier_deja_fait :
    ...
    if 'fichier_max_qui_manquent_dernier.pickle' in os.listdir() :
        #with open("fichier_max_"+nom_extension+".pickle", 'rb') as fichier_max_pickle :
        with open("fichier_max_qui_manquent_dernier.pickle", 'rb') as fichier_max_pickle :
    ...
    with open("fichier_similarite_qui_manquent.txt", 'a') as fichier_ecriture :
        
                graphe_motif = nx.MultiGraph()
                for i in range(1,6) :
                    graphe_motif.add_node((i,i))
                graphe_motif.add_edge((1,1),(2,2), type="CSS")
                graphe_motif.add_edge((1,1),(3,3), type="COV")
                graphe_motif.add_edge((1,1),(5,5), type="TSS")
                graphe_motif.add_edge((2,2),(4,4), type="COV")
                graphe_motif.add_edge((2,2),(5,5), type="CWW")
                graphe_motif.add_edge((3,3),(4,4), type="CSS")
    ...
    #         with open("fichier_similarite_4V9F_0_62_12_2.txt", 'a') as fichier_ecriture_3 :
                for fic in os.listdir("graphes_extension/fichiers_couples_qui_manquent/sans_boucle") :
                    if "pickle" in fic : 
                        tps1 = time.time()
                        #fic = "couples_possibles_fichier_5FDU_1A_74_7_fichier_4V9F_0_207_3.pickle"
                        print(fic)
                        ...
                        if (element1, element2) not in tab_deja_fait :
                            ...
                            with open("graphes_extension/"+element1+".pickle", 'rb') as fichier1 :
                                ...
                                with open("graphes_extension/"+element2+".pickle", 'rb') as fichier2 :
                                    ...
                                    with open("graphes_extension/fichiers_couples_qui_manquent/sans_boucle/"+fic, 'rb') as fichier_pickle :
                                                    memory_error = False
   
                                                    mon_depickler = pickle.Unpickler(fichier_pickle)
                                                    couples_possibles = mon_depickler.load()
                                                    #print(fic)
#                                                     print(len(couples_possibles[3]))
                                                        ...
                                                        if memory_error == False :
                                                            ...
                                                            for i in range(4) :
                                                                ...
                                                                for elt in couples_possibles[i] :
                                                                    compteur += 1
                                                                    graphe_commun = comparaison(elt, graphe1, graphe2, couples_possibles, i+1, graphe_commun)
...
#                                                                 try : 
#                                                                     graphe_commun_max = nx.union(graphe_commun_max, graphe_commun_max_temp)   
#                                                                 except Exception :
                                                            ...
                                                            with open("fichier_max_qui_manquent_dernier.pickle", 'wb') as fichier_max_pickle :
                            ...
                            with open("tab_calcules_sim_qui_manquent_dernier.pickle", 'wb') as fichier_deja_fait :
